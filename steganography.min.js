  ...
  var a = function () {},
    b = {
      ...
      findNextPrime: function (a) {
        for (var c = a; !0; c += 1) if (b.isPrime(c)) return c;
      },
      sum: function (a, b, c) {
        var d = 0;
        c = c || {};
  ...
  return (
    ...
    (a.prototype.encode = function (a, c, d) {
      ...
      (l.style.display = "none"),
        ...
        d.height && d.width
          ? m.drawImage(c, 0, 0, d.width, d.height)
          : m.drawImage(c, 0, 0);
      var n,
        o,
        p,
        ...
        v,
        w,
        x = m.getImageData(0, 0, l.width, l.height),
        y = x.data,
        z = (h / f) >> 0,
        A = h % f,
        B = [];
      for (v = 0; v <= a.length; v += 1) {
        if (((s = a.charCodeAt(v) || 0), (t = (A * v) % f), t > 0 && o)) {
          if (
            ...
            for (
              u = Math.pow(2, 2 * f - t) * (1 - Math.pow(2, -f)), w = 1;
              z > w;
              w += 1
            )
              (n = s & u), B.push(n >> ((w - 1) * f + (f - t))), (u <<= f);
            (A * (v + 1)) % f === 0
              ? ((u = Math.pow(2, h) * (1 - Math.pow(2, -f))),
                (n = s & u),
                B.push(n >> (h - f)))
              : f >= ((A * (v + 1)) % f) + (f - t) &&
                ((n = s & u), B.push(n >> ((z - 1) * f + (f - t))));
          }
        } else if (v < a.length)
          for (u = Math.pow(2, f) - 1, w = 0; z > w; w += 1)
            (n = s & u), B.push(n >> (w * f)), (u <<= f);
        o = s;
      }
      var C,
        D,
      ...
      for (C = 0; 4 * (C + g) <= y.length && C + g <= B.length; C += g) {
        for (G = [], v = 0; g > v && v + C < B.length; v += 1) {
          for (F = 0, w = C; g + C > w && w < B.length; w += 1)
      ...
      for (
        D = C + E;
        D - (C + E) < H.length && 4 * (C + H.length) < y.length;
        D += 1
      )
        y[4 * D + 3] = H[D - (C + E)];
    ...
    (a.prototype.decode = function (a, c) {
      ...
      (j.style.display = "none"),
        ...
        c.height && c.width
          ? k.drawImage(a, 0, 0, c.width, c.height)
          : k.drawImage(a, 0, 0);
      var l,
        m,
        n = k.getImageData(0, 0, j.width, j.height),
        o = n.data,
        p = [];
      if (1 === f)
        for (l = 3, m = !1; !m && l < o.length && !m; l += 4)
          (m = i(o, l, f)), m || p.push(o[l] - (255 - h + 1));
      var q = "",
        r = 0,
        s = 0,
        t = Math.pow(2, g) - 1;
